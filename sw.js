...
const SENSITIVE_QUERY_KEYS=new Set(['token','access_token','refresh_token','password','secret','session','auth','authorization','api_key','apikey','key']);
